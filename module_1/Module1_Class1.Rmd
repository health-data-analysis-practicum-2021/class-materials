...
* You may collaborate with other students using Github
...
Since the the default working directory (where R looks for files) is the project directory, we need to tell R where to find this data file.  In the path above, you can see that we tell R to look in the `modeul_1` folder and then give it the file name.
...
* Submit your data display in R Markdown through Github by Sunday (January 31, 2021) at midnight. You can find a link to create this assignment in Github on Blackboard.
